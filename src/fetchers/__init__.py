...
from src.fetchers.deutschebahn import DeutscheBahnFetcher
...
FETCHER_TYPES: dict[str, type[BaseFetcher]] = {
    "deutschebahn": DeutscheBahnFetcher,
...
__all__ = ["BaseFetcher", "DeutscheBahnFetcher", "DeutschePostFetcher", "EdekaFetcher", "GoogleFetcher", "GreenhouseFetcher", "MercedesBenzFetcher", "SiemensFetcher", "SmartRecruitersFetcher", "SuccessFactorsFetcher", "VolkswagenFetcher", "WorkdayFetcher", "FETCHER_TYPES"]
